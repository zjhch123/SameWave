...
- Scroll through custom AI settings with Done always accessible. Edits save immediately; valid configuration enables all consumers. Invalid input stays visible and blocks new AI requests.
